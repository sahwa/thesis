...
On the other hand, there is a clear effect of the 0.1x samples shifting to the centre of the post-GLIMPSE PCA. This suggests that coverage-related bias is being introduced in the imputation stage. Interestingly, GLIMPSE appears to have removed some of the noise in some of the downsampled individuals. For instance, the noise observed in the LBK samples in the pre-imputation PCA is substantially reduced, as all the samples fall on the same point. 
